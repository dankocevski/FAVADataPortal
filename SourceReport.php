...
<body id="body-plain">
	...
	<script type="text/javascript">
		...
		function fillSideTable(data) {
			...
			document.getElementById('table_ra').innerHTML = sourceRecord['best_ra'] + '°';
			document.getElementById('table_dec').innerHTML = sourceRecord['best_dec'] + '°';
			document.getElementById('table_r95').innerHTML = sourceRecord['best_r95'] + '°';
			...
			if (sourceRecord['bestPositionSource'] === 'low') {
				...
				document.getElementById('table_galb').innerHTML = sourceRecord['le_gall'] + '°';
				document.getElementById('table_gall').innerHTML = sourceRecord['le_galb'] + '°';
			} else if (sourceRecord['bestPositionSource'] === 'high')  {
				document.getElementById('table_source').innerHTML = 'Likelihood (HE)';	
				document.getElementById('table_galb').innerHTML = sourceRecord['he_gall'] + '°';
				document.getElementById('table_gall').innerHTML = sourceRecord['he_galb'] + '°';
			} else {
			...
			document.getElementById('le_ra').innerHTML = sourceRecord['le_ra'] + '°';
			document.getElementById('le_dec').innerHTML = sourceRecord['le_dec'] + '°';
			document.getElementById('le_r95').innerHTML = sourceRecord['le_r95'] + '°';
			...
			document.getElementById('he_ra').innerHTML = sourceRecord['he_ra'] + '°';
			document.getElementById('he_dec').innerHTML = sourceRecord['he_dec'] + '°';
			document.getElementById('he_r95').innerHTML = sourceRecord['he_r95'] + '°';
