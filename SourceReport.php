		   ...
		   // Circles
		    g.selectAll("_3FGLCatalog")
		      ...
		      .on("mouseover", function(d) {
					...
					var innerHTML =  d.Source_Name + '<BR>RA: ' + d.RAJ2000 + ', Dec: ' + d.DEJ2000 + '<BR>Association: <a href=\"http://www.google.com/search?q=\'' + d.ASSOC1 + '\'\" target="_blank">' + d.ASSOC1 + '</a><BR>' + lightcurveLink_3FGL  + ' | ' + spectrum + "<BR>" + lightcurveLink_FAVA;
